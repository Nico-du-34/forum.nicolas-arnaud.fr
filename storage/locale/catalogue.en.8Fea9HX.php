...
',
    ...
    'tohsakarat-tags-filter.forum.index_page.filter_tags.accessible_label' => 'tags filter',
    'tohsakarat-tags-filter.forum.index_page.filter_tags.all' => 'all',
    'tohsakarat-tags-filter.forum.index_page.filter_tags.label' => '{text}',
    'tohsakarat-tags-filter.forum.index_page.filter_tags.search_label' => 'Search...',
    'tohsakarat-tags-filter.forum.index_page.filter_tags.no_results' => 'No results',
    'tohsakarat-tags-filter.forum.index_page.filter_tags.start_typing' => 'Start typing...',
    'tohsakarat-tags-filter.forum.index_page.filter_tags.keep_typing' => 'Typing...',
    'tohsakarat-tags-filter.forum.index_page.filter_tags.remove_filter' => 'stop searching;',
    'tohsakarat-tags-filter.forum.index_page.filter_tags.comment_filter' => 'Click pinned tags to cancel~',
    'justoverclock-hot-discussion-cards.forum.post' => '{count, plural, one {POST} other {POSTS}}',
    'justoverclock-hot-discussion-cards.forum.hot' => 'TOP!',
...
',
    ...
    'extiverse-mercury.admin.extension-updates-page.extension-name' => 'Extension',
    'extiverse-mercury.admin.extension-updates-page.extension-is-up-to-date' => 'Is up to date',
    'extiverse-mercury.admin.extension-updates-page.highest-version' => 'Latest release',
    'extiverse-mercury.admin.extension-updates-page.installed-version' => 'Installed release',
    'extiverse-mercury.admin.settings.token' => 'Extiverse token (<a>request</a>)',
    'extiverse-mercury.admin.settings.token-description' => 'Retrieve an API token from <a>Extiverse</a> so that Mercury can securely communicate with your Flarum community.
',
    'extiverse-mercury.admin.header-secondary.no-token' => 'Token Required',
    'extiverse-mercury.admin.header-secondary.updates' => '{count, plural, =0 {No updates} one {One update} other {# updates}}',
    'extiverse-mercury.email.new-extension-update.subject' => '{count, plural, one {One update available for your community} other {# updates available for your community}}',
    'extiverse-mercury.email.new-extension-update.body' => 'Hey {recipient_display_name}!
...
',
    'datlechin-flarum-scroll-buttons.admin.scroll_to_top_label' => 'Scroll to top',
    'datlechin-flarum-scroll-buttons.admin.scroll_to_top_help' => 'Show a button to scroll to the top of the page',
    'datlechin-flarum-scroll-buttons.admin.scroll_to_bottom_label' => 'Scroll to bottom',
    'datlechin-flarum-scroll-buttons.admin.scroll_to_bottom_help' => 'Show a button to scroll to the bottom of the page',
